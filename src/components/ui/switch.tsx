  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className="pointer-events-none block size-3.5 rounded-full bg-background shadow-sm ring-0 transition-transform data-[checked]:translate-x-[14px] data-[unchecked]:translate-x-0.5"
      />
    </SwitchPrimitive.Root>
  )
}
